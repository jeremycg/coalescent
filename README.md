...
whole set. `patches/community/` holds bigger, fully-produced patches
contributed by users — see its README for credits and setup. They're generated by the scripts in `tools/` and, on WSL, are also
